...
#define CONFIGURE_ARGS "--enable-thread-safety --enable-nls --with-ldap --with-ssl=openssl --with-uuid --with-libxml --with-libxslt --with-lz4 --with-zstd --with-icu --with-tcl --with-perl --with-python"
...
#define PG_VERSION_STR "PostgreSQL 16.3, compiled by Visual C++ build " CppAsString2(_MSC_VER) ", 64-bit"
